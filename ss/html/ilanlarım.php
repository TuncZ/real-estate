...
<div class="ilan"> 
    ...
    <table border="" style="width:100%">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>";
            echo "<td><img src='" . $row['resim'] . "' alt='" . $row['baslik'] . "' style='max-width: 100px; max-height: 100px;'></td>";
            echo "<td>" . $row['baslik'] . "</td>";
            echo "<td>" . $row['metrekare'] . "</td>";
            echo "<td>" . $row['odasayi'] . "</td>";
